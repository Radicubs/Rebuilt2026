...
public final class CTREConfigs {
    ...
    public CTREConfigs(InvertedValue driveMotorInvert, InvertedValue angleMotorInvert) {
        ...
        swerveAngleFXConfig.MotionMagic.MotionMagicCruiseVelocity = Constants.Swerve.magicMotionTopSpeed;
        swerveAngleFXConfig.MotionMagic.MotionMagicAcceleration = Constants.Swerve.magicMotionAccel;
        swerveAngleFXConfig.MotionMagic.MotionMagicJerk = Constants.Swerve.magicMotionJerk;
